...
export interface SmartCreateOptions { options?: SessionOptions; fallbackEndpoint?: string; signal?: AbortSignal; onProgress?: (progress: Progress) => void; onStatus?: (status: Status) => void; globalObject?: any; fetchImpl?: typeof fetch | null; preferWebLLM?: boolean; webllmModel?: string; webllmModule?: any; maxFallbackTurns?: number; maxTokenBudget?: number; useTokenBudget?: boolean }
